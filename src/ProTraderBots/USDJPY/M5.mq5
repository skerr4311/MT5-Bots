...
static input double Maximum_Amount  = 0.1; // Maximum position amount [lot]
...
input int Slot0IndParam2 = 19; // Kijun
input int Slot0IndParam4 = 38; // Senkou Span B
static input string IndicatorName1 = "MACD"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 12; // Slow MA period
input int Slot1IndParam1 = 8; // Fast MA period
...
input int Slot2IndParam1 = 23; // Fast MA period
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.Description            = "Exported on 5.11.2024 г. from Forex Strategy Builder Professional, v4.3.3";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 53;
   strategy.MinBarsRequired        = 56;
   ...
   strategy.Slot[2].IndicatorPointer.ListParam[1].Text    = "Weighted";
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[1].Text    = "Weighted";
